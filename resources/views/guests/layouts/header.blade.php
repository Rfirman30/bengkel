    ...
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            ...
            <ul>
                ...
                @else
                    <li>
                        <a class="nav-link scrollto" href="{{route('login')}}"<i class="bi bi-arrow-right-square"></i>Log-in</a>
                    </li>
                    <li><a class="nav-link scrollto" href="{{route('register')}}"<i class="bi bi-arrow-right-square"></i>Sign-in</a></li>
                @endauth
            </ul>
