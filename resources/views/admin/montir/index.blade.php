    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <a href="{{ url('montir-pdf') }}" class="btn btn-danger mb-4" title="Export PDF">
                ...
                <a href="{{ url('montir-excel') }}" class="btn btn-success mb-4" title="Export Excel">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('montir.destroy', $mntr->id) }}" method="POST">
                                            ...
                                            <a href="{{ route('montir.edit', $mntr->id) }}" class="btn btn-warning btn-sm" title="Edit detail">
